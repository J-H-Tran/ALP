...
public class BinaryIOMain {
     ...
     * */
        try (FileOutputStream binFile = new FileOutputStream("data.dat");
            ...
            buffer.putInt(1000);
            buffer.flip();
            binChannel.write(buffer); // write() reads from buffer
            // less flip() calls when making multiple writes before reading from the buffer first by allocating large initial buffer size
