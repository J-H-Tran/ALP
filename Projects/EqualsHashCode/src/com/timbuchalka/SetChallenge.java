...
public class SetChallenge {
    public static void main(String[] args) {
        ...
        * so that your program can create objects of the appropriate3 type.
        *
        * our solar systems will allow 2 bodies to  have the same name as long as they are not the
        * same type of body: so you could have a start called B2 and an asteroid called B2
        *
        ...
        *
        * Test cases:
        * 1. planets and moons that we added previously should appear in
        * the solarSystem collection and in the sets of moons for the appropriate planets.
        *
        * 2. a.equals(b) must be symmetrical
        *
